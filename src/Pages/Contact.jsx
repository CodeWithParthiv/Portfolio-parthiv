  ...
  return (
    <>
      ...
      <div
        ...
        id="Contact"
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-2">
          <div
            data-aos="fade-right"
          ...
          >
            ...
            <form 
              action="https://formsubmit.co/parthibmajumdar83@gmail.com"
              method="POST"
