...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: " http://www.linkedin.com/in/parthiv-majumdar-524046238",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@parthivv.v_",
    icon: Instagram,
    url: " https://www.instagram.com/parthivv.v_",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@CodeWithParthiv",
    icon: Github,
    url: " https://github.com/CodeWithParthiv",
    color: "#ffffff",
